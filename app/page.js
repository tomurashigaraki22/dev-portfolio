...
const projects = [
  ...
  },
  {
    ...
    description: "Advanced trading platform with multi-chain blockchain integration and real-time market data.",
  ...
  },
  {
    ...
    url: null,
    description: "Comprehensive school management system with testing, drills, and educational tools for modern learning.",
  ...
  },
  {
    ...
    url: null,
    description: "Private company communication platform facilitating secure calls and messaging within organizations.",
  ...
  },
  {
    name: "Trollz App",
    url: null,
    description: "E-commerce platform for the Nigerian market with seamless shopping and payment integration.",
  ...
  },
  {
    ...
    url: null,
    description: "Lightweight server monitoring agent built with Go for tracking system status and health metrics.",
  ...
  },
  {
    ...
    url: null,
    description: "Mobile rideshare application connecting drivers and passengers with real-time location tracking.",
    tech: ["React Native", "Node.js", "Flask"],
    status: "Live",
  },
  {
